# -*- coding: utf-8 -*-
"""
Created on Fri Jan 21 12:49:27 2022
...
class img_controller(object):
    ...
    def canny(self):
        ...
        self.canny = cv2.Canny(self.img1,150,200)
        #otau轉換後type為 numpy.ndarray
        print(type(self.canny))
        height, width = self.canny.shape
        bytesPerLine =  self.origin_width  #grayscale只有1個channel
        self.canny1 = QImage(self.canny, width, height, bytesPerLine, QImage.Format_Grayscale8).rgbSwapped()
        #numpy.ndarray轉成Qimage
        self.origin_qpixmap = QPixmap.fromImage(self.canny1)
        #Qimage轉換成Qpixmap
        print(type(self.canny1))
        self.set_img_ratio()
