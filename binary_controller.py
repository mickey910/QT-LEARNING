# -*- coding: utf-8 -*-
"""
Created on Fri Jan 21 13:44:22 2022
...
from binary import Ui_MainWindow
from binary_img_controller import img_controller
...
class MainWindow_controller(QtWidgets.QMainWindow):
    ...
    def setup_control(self):        
        ...
        self.ui.img_processing.clicked.connect(self.img_controller.binary)
    ...
    def getslidervalue(self):        
        self.img_controller.set_slider_value(self.ui.horizontalSlider.value()*2.25)